...
public class GuideActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<pageViews.size();i++){
            ...
            if(i==0){
                imageViews[i].setBackgroundResource(R.drawable.choosewyuan);
            }else{
                imageViews[i].setBackgroundResource(R.drawable.wyuan);
            }
    ...
    class GuidePageAdapter extends PagerAdapter{
        ...
        public Object instantiateItem(View v, int position) {
            ...
            ((ViewPager) v).addView(pageViews.get(position));  
             ...
             // 测试页卡1内的按钮事件  
            if (position == 2) {  
                TextView btn = (TextView) v.findViewById(R.id.btn_close_guide1);  
    ...
    class GuidePageChangeListener implements OnPageChangeListener{
        ...
        public void onPageSelected(int position) {
            ...
            for(int i=0;i<imageViews.length;i++){
                imageViews[position].setBackgroundResource(R.drawable.choosewyuan);
