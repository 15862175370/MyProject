...
/**
 * Servlet implementation class AddInfoMessagePraiseServlet
 */
@WebServlet("/AddInfoMessagePraiseServlet")
public class AddInfoMessagePraiseServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean b = dao.addInfoMessagePraise(infoMessagePraise);
		if(b == true){
