...
import com.liwei.adapter.KaoQinAdapter;
...
public class KaoQinActivity extends Activity {
	...
	public void initView(){
		...
		lv=(ListView) findViewById(R.id.kaoqin);
		HttpUtils utils=new HttpUtils();
	RequestParams params=new RequestParams();
	params.addBodyParameter("cno",String.valueOf(cno));
	utils.send(HttpMethod.POST, UrlUtils.url+"/KaoQinServlet", params, new RequestCallBack<String>() {

		@Override
		public void onFailure(HttpException arg0, String arg1) {
			ToastUtils.getToast(KaoQinActivity.this, "请求网络失败");
		...
		public void onSuccess(ResponseInfo<String> responseInfo) {
			...
			Gson gson=new Gson();
			Type classOfT=new TypeToken<List<KaoQin>>(){}.getType();
			List<KaoQin> list1=gson.fromJson(list, classOfT);
			KaoQinAdapter adapter=new KaoQinAdapter(KaoQinActivity.this, list1);
