			...
			if(et.getText().toString().equals("")){
				...
				utils.send(HttpMethod.POST, UrlUtils.url+"/SearchStudentServlet",params, new RequestCallBack<String>() {
					...
					public void onSuccess(ResponseInfo<String> responseInfo) {
						...
						if(list.equals("[]")){
							ToastUtils.getToast(SearchStudentActivity.this, "您查找的内容不存在");
						}
						Gson gson=new Gson();
						Type classOfT=new TypeToken<List<MyStudentBean>>(){}.getType();
						List<MyStudentBean> list1=gson.fromJson(list, classOfT);
						SearchStudentAdapter adapter =new SearchStudentAdapter(SearchStudentActivity.this, list1,SearchStudentActivity.this);
