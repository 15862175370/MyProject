		...
		regist.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(!cno.getText().toString().equals("")&&!cname.getText().toString().equals("")
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							utils.send(HttpMethod.POST, UrlUtils.url+"/RegistCourseServlet",params ,new RequestCallBack<String>() {
								...
								public void onFailure(HttpException arg0,
									...
									ToastUtils.getToast(CourseRegist.this, "注册课程失败");
								}
								...
								if(flag.equals("true")){
									ToastUtils.getToast(CourseRegist.this, "注册成功");
									finish();
								}else {
									ToastUtils.getToast(CourseRegist.this, "注册失败");
								}
					...
					ToastUtils.getToast(CourseRegist.this, "请确保所填内容都不为空");
				}
