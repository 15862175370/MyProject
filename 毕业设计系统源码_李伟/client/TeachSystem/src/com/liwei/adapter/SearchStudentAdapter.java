...
import com.liwei.activity.EditStudent;
import com.liwei.activity.SearchStudentActivity;
...
public class SearchStudentAdapter extends BaseAdapter {
	private SearchStudentActivity sr;
	private List<MyStudentBean> list;
	private Context context;
	 public SearchStudentAdapter(Context context,List<MyStudentBean> list,SearchStudentActivity sr) {
	...
	public View getView(int position, View containView, ViewGroup viewGroup) {
		...
		holder.delete.setOnClickListener(new OnClickListener() {
			...
			utils.send(HttpMethod.POST, UrlUtils.url+"/DeleteStudentServlet", params, new RequestCallBack<String>() {
		...
		holder.change.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra("mystudent", myStudentBean);
